logitmfxRE<-function (formula, data, atmean = TRUE, robust = FALSE, clustervar1 = NULL, 
          clustervar2 = NULL, start = NULL, control = list(), recorrect) 
{
  res = logitmfxestRE(formula, data, atmean, robust, clustervar1, 
                    clustervar2, start, control, recorrect)
  est = NULL
